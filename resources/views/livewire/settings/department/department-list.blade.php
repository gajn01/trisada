<div>
    ...
    <div class="row g-3 mb-4 align-items-center justify-content-between">
        <div class="col-auto">
            <h1 class="app-page-title mb-0">Departments</h1>
        </div>
        <div class="col-auto">
            ...
            <div class="table-responsive">
                <table class="table app-table-hover mb-0 text-left">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="cell d-none d-lg-table-cell"><span>{{ $d->code }}</span></td>
                            <td class="cell d-none d-lg-table-cell"><span>{{ $d->name }}</span></td>
                            <td class="cell d-lg-none clickable" onclick="window.location.href = '{{ route('department-details',[$d->id]) }}'">
                                <span class="fw-bold">Code: </span> <span>{{ $d->code }}</span><br>
                                <span class="fw-bold">Name: </span> <span>{{ $d->name }}</span><br>
                            </td>
                            <td class="cell text-end">
                                <a class="btn btn-link link-primary px-1" title="View" href="{{ route('department-details',[$d->id]) }}">
                                    <i class="fa-eye fa-solid"></i>
                                </a>
                                @if(Gate::allows('allow-delete','module-departments'))
                                <a class="btn btn-link link-danger px-1" title="Delete"  href="#" wire:click="markDelete({{$d->id}})" data-bs-toggle="modal" data-bs-target="#deleteModal">
                ...
                <div class="modal-body">
                    <div class="settings-form">
                        <div class="mb-2">
                            ...
                            <input id="code" name="code" wire:model.defer="department.code" type="text" class="form-control form-control-sm" required>
                        ...
                        <div class="mb-2">
                            ...
                            <input id="name" name="name" wire:model.defer="department.name" type="text" class="form-control form-control-sm" required>
                            @error('department.name') <span class="text-danger">{{ $message }}</span> @enderror     
                        </div>
                        <div class="mb-2">
                            <label for="description" class="form-label small">Description</label>
                            <textarea id="description" name="description" wire:model.defer="department.description" type="text" class="form-control form-control-sm" required></textarea>
