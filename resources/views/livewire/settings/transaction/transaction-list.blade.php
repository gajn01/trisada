        ...
        <div class="col-auto">
             <div class="page-utilities">
                <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                    ...
                    @if(Gate::allows('allow-create','module-transactions'))
                    <div class="col-auto">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="area" name="area" wire:model.defer="transactionType.area" type="text" class="form-control form-control-sm" required>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="route_code" name="route_code" wire:model.defer="transactionType.route_code" type="text" class="form-control form-control-sm" required>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="concatenate" name="concatenate" wire:model.defer="transactionType.concatenate" type="text" class="form-control form-control-sm" required>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="scheme" name="scheme" wire:model.defer="transactionType.scheme" type="text" class="form-control form-control-sm" required>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="km_travelled" name="km_travelled" wire:model.defer="transactionType.km_travelled" type="number" class="form-control form-control-sm" required>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="liters" name="liters" wire:model.defer="transactionType.liters" type="number" class="form-control form-control-sm" required>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="fuel" name="fuel" wire:model.defer="transactionType.fuel" type="number" class="form-control form-control-sm" required>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input id="fuel_cash_request" name="fuel_cash_request" wire:model.defer="transactionType.fuel_cash_request" type="number" class="form-control form-control-sm" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    <label for="p_o" class="form-label small">P.O.</label>
                                    <input id="p_o" name="p_o" wire:model.defer="transactionType.p_o" type="number" class="form-control form-control-sm" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    <label for="salary" class="form-label small">Salary</label>
                                    <input id="salary" name="salary" wire:model.defer="transactionType.salary" type="number" class="form-control form-control-sm" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    <label for="food_allowance" class="form-label small">Food Allowance</label>
                                    <input id="food_allowance" name="food_allowance" wire:model.defer="transactionType.food_allowance" type="number" class="form-control form-control-sm" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    <label for="parking" class="form-label small">Parking</label>
                                    <input id="parking" name="parking" wire:model.defer="transactionType.parking" type="number" class="form-control form-control-sm" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    <label for="easytrip" class="form-label small">Easytrip</label>
                                    <input id="easytrip" name="easytrip" wire:model.defer="transactionType.easytrip" type="number" class="form-control form-control-sm" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    <label for="autosweep" class="form-label small">Autosweep</label>
                                    <input id="autosweep" name="autosweep" wire:model.defer="transactionType.autosweep" type="number" class="form-control form-control-sm" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-2">
                                    <label for="toll_fee" class="form-label small">Toll Fee</label>
                                    <input id="toll_fee" name="toll_fee" wire:model.defer="transactionType.toll_fee" type="number" class="form-control form-control-sm" required>
                                </div>
                            </div>
                        </div>
