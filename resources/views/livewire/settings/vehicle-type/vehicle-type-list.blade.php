<div>
    ...
    <div class="row g-3 mb-4 align-items-center justify-content-between">
        <div class="col-auto">
            <h1 class="app-page-title mb-0">Vehicle Types</h1>
        </div>
        <div class="col-auto">
        ...
        <div class="app-card-body">
            ...
            <div class="table-responsive">
                <table class="table app-table-hover mb-0 text-left">
                    ...
                    <tbody>
                        @forelse ($vehicleTypes as $v)
                        <tr>
                            <td class="cell d-none d-lg-table-cell"><span>{{ $v->code }}</span></td>
                            <td class="cell d-none d-lg-table-cell"><span>{{ $v->name }}</span></td>
                            <td class="cell d-lg-none clickable" onclick="window.location.href = '{{ route('vehicle-type-details',[$v->id]) }}'">
                                <span class="fw-bold">Code: </span> <span>{{ $v->code }}</span><br>
                                <span class="fw-bold">Name: </span> <span>{{ $v->name }}</span><br>
                            </td>
                            <td class="cell text-end">
                                <a class="btn btn-link link-primary px-1" title="View" href="{{ route('vehicle-type-details',[$v->id]) }}">
    ...
    <nav class="app-pagination">
        <div class="row justify-content-between">
            ...
            <div class="col-auto mb-2">
                {{ $vehicleTypes->onEachSide(1)->links() }}
            </div>
        </div>
    </nav><!--//app-pagination-->
    <!-- Delete Modal -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Delete Vehicle Type</h6>
    ...
    <div wire:ignore.self class="modal fade" id="createModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Create Vehicle Type</h6>
                ...
                <div class="modal-body">
                    <div class="settings-form">
                        <div class="mb-2">
                            ...
                            <input id="code" name="code" wire:model.defer="vehicleType.code" type="text" class="form-control form-control-sm" required>
                        ...
                        <div class="mb-2">
                            ...
                            <input id="name" name="name" wire:model.defer="vehicleType.name" type="text" class="form-control form-control-sm" required>
                            @error('vehicleType.name') <span class="text-danger">{{ $message }}</span> @enderror     
                        </div>
                        <div class="mb-2">
                            <label for="description" class="form-label small">Description</label>
                            <textarea id="description" name="description" wire:model.defer="vehicleType.description" type="text" class="form-control form-control-sm" required></textarea>
