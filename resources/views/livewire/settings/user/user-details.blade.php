...
<div>
            ...
            <div class="app-card app-card-settings shadow-sm p-4">
                <div class="app-card-body">
                    ...
                    <div class="item border-bottom py-3">
                        <div class="row justify-content-between align-items-center">
                            <div class="col">
                                ...
                                @else
                                <input wire:model.defer="user.contact_number" type="contactno" class="form-control" required>
                    ...
                    <div class="item border-bottom py-3">
                        <div class="row justify-content-between align-items-center">
                            <div class="col">
                                <div class="item-label"><strong>User Type</strong><span class="text-danger">*</span></div>
                                @if($isedit == false)
        ...
        <div class="col-12 col-md-8">
            <div class="app-card app-card-settings shadow-sm p-4">
                ...
                <div class="app-card-body">
                    <div class="row">
                        ...
                        <div class="col-auto form-check form-switch ml-5 ">
                            @if(Gate::allows('access-enabled','module-set-status'))
                                ...
                                <input class="form-check-input" type="checkbox" wire:model="isactive" id="isactive" checked>
                                @endif
                            @endif
                    ...
                    <div class="mb-2"><strong>Date Created:</strong> {{ date('F d, Y h:i A', strtotime($user->date_created))}}</div>
                    <div class="mb-2"><strong>Date Last Updated:</strong> {{ date('F d, Y h:i A', strtotime($user->date_updated))}}</div>
                    <div class="mb-2"><strong>Email Verified:</strong>
                        @if(is_null($user->email_verified_at))
                            ...
                            <a class="link-primary" data-bs-toggle="modal" data-bs-target="#confirmOverride" href="#"><small class="p-1">Override Verification</small></a>
                            @endif
                        @else
    ...
    <div class="row g-4 settings-section">
        ...
        <div class="col-12 col-md-8">
            <div class="app-card shadow-sm p-4">
                <div class="app-card-body">
                    <div class="">
                        {{-- <h5>Warehouse Access Scope</h5> --}}
                        <div class="row mb-5">
                            @if(Gate::allows('access-enabled','module-set-access-scope'))
                            <div class="col-6 col-md-4">
                                <select class="form-select form-select-sm" wire:model="selectedDepartment">
                            ...
                            <div class="col-6 col-md-4 mb-3">
                                <button type="button" class="btn btn-sm btn-secondary" wire:click="addDepartment"><small>Add</small></button>
                            </div>
                            @endif
                            <div class="col-10 offset-1">
                                ...
                                <ol class="list-group list-group-numbered">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-start">
                                        ...
                                        @if(Gate::allows('access-enabled','module-set-access-scope'))
                                        <a class="btn btn-sm btn-link link-danger" title="Remove" wire:click="removeDepartment({{$dep->id}})">
                        ...
                        <li class="border-0 list-group-item d-flex justify-content-between align-items-center py-0">
                                ...
                                <div @class([
                                    ...
                                    <div class="form-check form-switch mb-3">
                                        ...
                                        <input class="form-check-input" type="checkbox" id="{{$module['module']}}" wire:model="useraccess.{{ $count }}.enabled">
                                        @endif
                                        <label @class(['form-check-label','fw-semibold'=> is_null($module['parent'])]) for="{{$module['module']}}">{{ $module['module_name']}}</label>
                                    </div>
                                </div>
                                <div class="col-5 col-lg-4">
                                    @if(!($module['module'] == "module-user-management" && auth()->user()->user_type > 1))
                                        @if($module['access_type'] == 1)
                                        <select class="form-select form-select-sm" wire:model="useraccess.{{ $count }}.access_level" style="max-width:12em" @if($useraccess[$count]['enabled'] == false) disabled @endif>
    ...
    <!-- Modal -->
    <div wire:ignore class="modal fade" id="confirmOverride" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="confirmOverrideLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary text-light" wire:click="overrideEmailVerification" data-bs-dismiss="modal">Yes</button>
    ...
    <!-- Modal -->
    <div wire:ignore class="modal fade" id="confirmResetPasswordModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="confirmResetPasswordLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
