        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item">
                    <a @class([
                        'nav-link',
                        'active' => Request::route()->named('driver-list'),
                                ...
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item">
                                        <a @class([
                                            'submenu-link',
                                            'active' =>
                                                Request::route()->named('customer-list') ||
                                                Request::route()->named('customer-details'),
                                        ]) href="{{ route('customer-list') }}">Customer Account</a>
                                    </li>
                                    <li class="submenu-item">
                                        <a @class([
                                            'submenu-link',
                                            'active' =>
                                                Request::route()->named('admin-list')
                                        ]) href="{{ route('admin-list') }}">Toda Account</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
