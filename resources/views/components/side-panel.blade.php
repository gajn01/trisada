 ...
 <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
     <div class="py-4 text-gray-500 dark:text-gray-400">
         <div class="w-20 flex  mx-auto">
             <img class="w-auto" src="../img/small.png" class="img-fluid i" alt="">
         </div>
         <ul class="mt-6">
             <li class="relative px-6 py-3">
                 ...
                 <a @class([
                     ...
                     'text-gray-900 dark:text-gray-100' => Request::route()->named('dashboard'),
         ...
         <ul>
             <li class="relative px-6 py-3">
                 @if (Request::route()->named('toda-list'))
                     <span class="absolute inset-y-0 left-0 w-1 bg-primary rounded-tr-lg rounded-br-lg"
                         aria-hidden="true"></span>
                 @endif
                 <a @class([
                     'inline-flex items-center w-full text-sm font-semibold transition-colors duration-150
                                                                                      hover:text-gray-800 dark:hover:text-gray-200',
                     'text-gray-900 dark:text-gray-100' => Request::route()->named('toda-list'),
                 ]) href="{{ route('toda-list') }}">
                     <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" class="bi bi-kanban"
                         viewBox="0 0 16 16">
                         <path
                     ...
                     <span class="ml-4">Toda Management</span>
                 </a>
             </li>
             <li class="relative px-6 py-3">
                 @if (Request::route()->named('terminal-list'))
                     <span class="absolute inset-y-0 left-0 w-1 bg-primary rounded-tr-lg rounded-br-lg"
                         aria-hidden="true"></span>
                 @endif
                 <a @class([
                     'inline-flex items-center w-full text-sm font-semibold transition-colors duration-150
                                                                                      hover:text-gray-800 dark:hover:text-gray-200',
                     'text-gray-900 dark:text-gray-100' => Request::route()->named('terminal-list'),
                     ...
                     <span class="ml-4">Terminal Management</span>
                 </a>
             </li>
             <li class="relative px-6 py-3">
 ...
 <div x-show="isSideMenuOpen" x-transition:enter="transition ease-in-out duration-150"
     ...
     {{--   @click.away="closeSideMenu"
         @keydown.escape="closeSideMenu" --}}></div>
